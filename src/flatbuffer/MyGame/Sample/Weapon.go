...
func FinishWeaponBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedWeaponBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
